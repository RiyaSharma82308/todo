    ...
    if request.method == 'GET':
        ...
        if request.POST['password1']==request.POST['password2']:
            try:
                ...
                return render(request,'todoapp/signupuser.html',{'form' : UserCreationForm() , 'error' : 'Username already exists. Please choose a new Username'})
        else:
...
def createtodo(request):          
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request,'todoapp/createtodo.html',{'form' : TodoForm(), 'error': 'Try again buddy. Seems like title size exceeded'})
@login_required
...
def viewtodo(request, todo_pk):
    ...
    if request.method=='GET':
        ...
        try:
            ...
            return render(request,'todoapp/viewtodo.html' , {'todo':todo , 'form':form , 'error':'Bad info buddy '})
